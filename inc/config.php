...
// SERVER & URL SETTINGS -- make this bulletproof
...
defined('BASE_URL')  ? null : define('BASE_URL', 'http://localhost:8888/projects/newproject');
...
defined('MODERNIZR_PATH') ? null : define('MODERNIZR_PATH', '../js/lib/modernizr.js');
